    ...
    <teleport to="body">
      <transition name="fade-in">
        <div
          v-if="show"
          @click="toggleModal"
          class="overlay   absolute left-0 bottom-0 right-0 top-0 flex items-center justify-center"
        >
          <div
            class="modal mt-10 bg-white shadow-lg rounded-md px-4 py-2 relative"
          >
            ...
            <div
              ...
              class=" z-20 close-modal cursor-pointer absolute top-2 right-2"
            >
